...
function client_calculate() {
	...
	vtc('sub29',진행상황,-2);   vtc('sub30',수수료등,2);    vtc('sub31',누적수료,2);    vtc('sub7',회복전략,1);
...
function load_value() {
    if( AutoCalculated ) return;
        ...
        누적수료= s_load('sub31','f');     회복전략 = s_load('sub7','f','G');            
        ...
        vtc('add7',평균단가,4);     vtc('sub15',매도누적,2);            vtc('sub14',매수누적,2);    vtc('add6',현매수금,2);
        vtc('sub5',연속상승,0);     vtc('sub6',연속하락,0);             vtc('sub28',종가변동,1);    vtc('sub7',회복전략,1);
