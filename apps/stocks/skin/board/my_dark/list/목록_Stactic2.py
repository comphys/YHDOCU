    ...
    def chart(self) :
        ...
        if chart_data :
            ...
            if  타겟일수 == 0 or 타겟일수 == 1 :
                ...
                cpn = self.take_chance(self.DB.parameters('02300'),int(VD['add9']),int(VD['sub2']),float(VD['add6']))
                cpc = self.take_chance(self.DB.parameters('02400'),int(VD['add9']),int(VD['sub2']),float(VD['add6']))
