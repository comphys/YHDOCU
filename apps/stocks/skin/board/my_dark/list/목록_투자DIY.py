...
class 목록_투자DIY(SKIN) :
    ...
    def chart(self) :
        ...
        self.D['업데이트안됨'] = False if last_chkd == last_ohlc or self.D['Page'] > '1' else True
            ...
            if  temp :
                ...
                for dte,bal,pro,ini,cat in temp :
                    if  cat == '초기셋팅' : 
                        ...
                        l_p = (bal/l_b - 1)*100 if l_b != 0 else 0.0 
                        b_p = (bal/b_b - 1)*100 if b_b != 0 else 0.0 
                        a_p =  bal-b_b
