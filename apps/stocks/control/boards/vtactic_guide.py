...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    def init_value(self) :
        ...
        self.M['평단가치']  = self.DB.parameters('003')   # 일반매수 구매가 범위
        self.M['큰단가치']  = self.DB.parameters('002')   # 매수첫날 구매가 범위
        self.M['첫매가치']  = self.DB.parameters('004')
        self.M['둘매가치']  = self.DB.parameters('005')
        self.M['강매시작']  = self.DB.parameters('008')
        self.M['강매가치']  = self.DB.parameters('007')
        self.M['위매비중']  = self.DB.parameters('010')
        self.M['회복기한']  = self.DB.parameters('006')
